...
mod test {
    use super::FighterKineticEnergyControl;

    use memoffset::offset_of;

    #[test]
    fn layout_check() {
        assert_eq!(offset_of!(FighterKineticEnergyControl, parent), 0x0);
        assert_eq!(offset_of!(FighterKineticEnergyControl, lr), 0x88);
        assert_eq!(offset_of!(FighterKineticEnergyControl, accel_mul_x), 0x8C);
        assert_eq!(offset_of!(FighterKineticEnergyControl, accel_add_x), 0x90);
        assert_eq!(offset_of!(FighterKineticEnergyControl, accel_mul_y), 0x94);
        assert_eq!(offset_of!(FighterKineticEnergyControl, accel_add_y), 0x98);
        assert_eq!(offset_of!(FighterKineticEnergyControl, _x9c), 0x9C);
        assert_eq!(offset_of!(FighterKineticEnergyControl, _xa0), 0xA0);
        assert_eq!(offset_of!(FighterKineticEnergyControl, unk), 0xA4);
    }
}
